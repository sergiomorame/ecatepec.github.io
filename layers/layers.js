...
var format_Incindecias_3 = new ol.format.GeoJSON();
var features_Incindecias_3 = format_Incindecias_3.readFeatures(json_Incindecias_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Incindecias_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Incindecias_3.addFeatures(features_Incindecias_3);
var lyr_Incindecias_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Incindecias_3, 
                style: style_Incindecias_3,
                popuplayertitle: 'Incindecias',
                interactive: true,
    title: 'Incindecias<br />\
    <img src="styles/legend/Incindecias_3_0.png" /> Drenaje tapado / Coladrera tapada / Tuberia tapada<br />\
    <img src="styles/legend/Incindecias_3_1.png" /> Solicitud de pipa<br />'
        });

lyr_Positron_0.setVisible(true);lyr_Ecatepec_1.setVisible(true);lyr_colonias_2.setVisible(true);lyr_Incindecias_3.setVisible(true);
var layersList = [lyr_Positron_0,lyr_Ecatepec_1,lyr_colonias_2,lyr_Incindecias_3];
...
lyr_Incindecias_3.on('precompose', function(evt) {
