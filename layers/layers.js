...
lyr_Incidenciasagua_3.set('fieldImages', {'Marca temp': 'TextEdit', 'Tipo de pr': 'TextEdit', 'Nombre(s)': 'TextEdit', 'Apellido(s': 'TextEdit', 'Municipio': 'TextEdit', 'Colonia/Ba': 'TextEdit', 'Avenida/Bo': 'TextEdit', 'N?mero e': '', 'N?mero I': '', 'C?digo P': '', 'Manzana/Lo': 'TextEdit', 'Lugar de r': 'TextEdit', 'Tel?fono': '', 'field_14': 'TextEdit', 'lon': 'TextEdit', 'field_16': 'TextEdit', });
...
lyr_Incidenciasagua_3.set('fieldLabels', {'Marca temp': 'inline label - always visible', 'Tipo de pr': 'inline label - always visible', 'Nombre(s)': 'no label', 'Apellido(s': 'hidden field', 'Municipio': 'hidden field', 'Colonia/Ba': 'hidden field', 'Avenida/Bo': 'hidden field', 'N?mero e': 'hidden field', 'N?mero I': 'hidden field', 'C?digo P': 'hidden field', 'Manzana/Lo': 'hidden field', 'Lugar de r': 'hidden field', 'Tel?fono': 'hidden field', 'field_14': 'hidden field', 'lon': 'hidden field', 'field_16': 'hidden field', });
